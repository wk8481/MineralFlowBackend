...
@AnalyzeClasses(packages = "be.kdg.prgramming6.landside", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    private static final String DOMAIN_LAYER = "be.kdg.prgramming6.landside.domain..";
    private static final String ADAPTER_LAYER = "be.kdg.prgramming6.landside.adapter..";
    private static final String CORE_LAYER = "be.kdg.prgramming6.landside.core..";
    private static final String PORT_LAYER = "be.kdg.prgramming6.landside.port..";
    ...
    public void givenApplicationClasses_thenNoLayerViolationsShouldExist() {
         JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prgramming6.landside");
