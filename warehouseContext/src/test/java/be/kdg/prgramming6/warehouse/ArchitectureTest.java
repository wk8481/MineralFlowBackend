package be.kdg.prgramming6.warehouse;
...
@AnalyzeClasses(packages = "be.kdg.prgramming6.warehouse", importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    private static final String DOMAIN_LAYER = "be.kdg.prgramming6.warehouse.domain..";
    private static final String ADAPTER_LAYER = "be.kdg.prgramming6.warehouse.adapter..";
    private static final String CORE_LAYER = "be.kdg.prgramming6.warehouse.core..";
    private static final String PORT_LAYER = "be.kdg.prgramming6.warehouse.port..";
    ...
    public void givenApplicationClasses_thenNoLayerViolationsShouldExist() {
         JavaClasses jc = new ClassFileImporter().importPackages("be.kdg.prgramming6.warehouse");
